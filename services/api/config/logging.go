	...
	config.Add("logging", map[string]any{
		...
		"channels": map[string]any{
			...
			"single": map[string]any{
				...
				// LOG_PRINT=true also writes to the console, which is where
				// Coolify reads container logs from.
			...
			"otel": map[string]any{
				"driver":          "otel",
				"instrument_name": config.GetString("APP_NAME", "dev.jevido/jevidocs/services/api/log"),
			},
		},
	})
}

...
func init() {
	...
	config.Add("database", map[string]any{
		...
		// Run pending migrations when the server starts (not for artisan
		// commands). On in production and local dev; see
		// app/database/migrate.go.
		"migrate_on_start": config.Env("DB_MIGRATE_ON_START", false),
	})
}
